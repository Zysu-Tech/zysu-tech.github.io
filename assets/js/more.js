                ...
                f(function () {
                    window.setTimeout(function () {
                        d.f(function () {
                            ...
                            e && (e.open("POST.html", b + (-1 == b.indexOf("?") ? "?" : "&") + "url=" + encodeURIComponent(c)), e.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), e.send(a));
                        });
                    }, 0);
                });
            }
    ...
    pagespeed.criticalCssBeaconInit("/ngx_pagespeed_beacon", "index-dark.html", "c_DGtnzDvR", "Kt13h_U3Ejw", pagespeed.selectors);
